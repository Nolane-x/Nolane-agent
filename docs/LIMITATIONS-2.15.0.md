# Forge Studio 2.15.0 — remaining limits
...
The cloud stage is eligibility after the local stages only. Forge Studio 2.15.0 does not claim that a cloud agent, cloud sandbox, hosted control plane, or remote worker was operated by this local release matrix.
...
The item-level source of truth is `docs/feature-audit-2.15.0.json`. The exhaustive open-item report is `docs/REMAINING-GAPS-2.15.0.md`.
