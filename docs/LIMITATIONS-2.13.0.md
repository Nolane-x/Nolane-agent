# Forge Studio 2.13.0 — remaining limits
...
The item-level source of truth is `docs/feature-audit-2.13.0.json`. The exhaustive open-item report is `docs/REMAINING-GAPS-2.13.0.md`.
