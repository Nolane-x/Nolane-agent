# Forge Studio 2.7.0 — Kiểm toán checklist tính năng
...
| 4 | Giao diện người dùng | 44 | 35 | 7 | 0 | 2 |
...
| 13 | Codebase intelligence | 40 | 39 | 0 | 0 | 1 |
| 14 | Công cụ đọc file | 20 | 19 | 1 | 0 | 0 |
| 15 | Công cụ tìm kiếm | 25 | 21 | 4 | 0 | 0 |
| 16 | Công cụ chỉnh sửa file | 30 | 23 | 7 | 0 | 0 |
| 17 | Patch engine | 20 | 17 | 3 | 0 | 0 |
| 18 | Terminal và shell tool | 34 | 26 | 8 | 0 | 0 |
...
| 27 | Worktree và đa nhiệm | 20 | 16 | 4 | 0 | 0 |
...
- **4.21 — Trình duyệt tích hợp:** not_implemented — Không tìm thấy bằng chứng source + test đủ cụ thể cho mục này trong cây source 2.7.0.
...
- **4.30 — Trình quản lý secrets:** not_implemented — Không tìm thấy bằng chứng source + test đủ cụ thể cho mục này trong cây source 2.7.0.
...
- **13.27 — Hỗ trợ tree-sitter:** not_implemented — Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 2.7.0.
...
- **18.22 — Hỗ trợ Bash:** partial — Có thành phần liên quan, nhưng hành vi item-level chưa đầy đủ hoặc chưa được chứng minh trên toàn bộ bề mặt/hạ tầng.
- **18.23 — Hỗ trợ WSL:** partial — Có thành phần liên quan, nhưng hành vi item-level chưa đầy đủ hoặc chưa được chứng minh trên toàn bộ bề mặt/hạ tầng.
- **18.28 — Không chạy server không quản lý PID:** partial — Có thành phần liên quan, nhưng hành vi item-level chưa đầy đủ hoặc chưa được chứng minh trên toàn bộ bề mặt/hạ tầng.
- **19.6 — Lệnh thay đổi hệ thống:** partial — Có thành phần liên quan, nhưng hành vi item-level chưa đầy đủ hoặc chưa được chứng minh trên toàn bộ bề mặt/hạ tầng.
- **19.11 — Lệnh thay đổi quyền:** partial — Có thành phần liên quan, nhưng hành vi item-level chưa đầy đủ hoặc chưa được chứng minh trên toàn bộ bề mặt/hạ tầng.
- **19.12 — Lệnh chạy mã tải từ internet:** partial — Có thành phần liên quan, nhưng hành vi item-level chưa đầy đủ hoặc chưa được chứng minh trên toàn bộ bề mặt/hạ tầng.
- **19.14 — Lệnh chạy với administrator:** partial — Có thành phần liên quan, nhưng hành vi item-level chưa đầy đủ hoặc chưa được chứng minh trên toàn bộ bề mặt/hạ tầng.
- **19.15 — Lệnh thay đổi firewall:** partial — Có thành phần liên quan, nhưng hành vi item-level chưa đầy đủ hoặc chưa được chứng minh trên toàn bộ bề mặt/hạ tầng.
- **19.16 — Lệnh khởi động service:** partial — Có thành phần liên quan, nhưng hành vi item-level chưa đầy đủ hoặc chưa được chứng minh trên toàn bộ bề mặt/hạ tầng.
