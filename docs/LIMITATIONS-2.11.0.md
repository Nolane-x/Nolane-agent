# Forge Studio 2.11.0 — remaining limits

The item-level source of truth is `docs/feature-audit-2.11.0.json`. The exhaustive open-item report is `docs/REMAINING-GAPS-2.11.0.md`.
