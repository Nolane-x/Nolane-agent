# Forge Studio 2.25.0 — Remaining Gaps Report

- Tổng yêu cầu: **1150**
- Còn lại: **321**
- Hoàn thành một phần: **66**
- Cổng bên ngoài: **56**
- Chưa triển khai: **199**
- Audit SHA-256: `35e0bd67fb14d204353a6ae1f210322ab3440752a49b2672432dd44509a44f48`
- Receipt SHA-256: `4cd486474438c24831ee3eb7cdb9c66bb9d8f9d3a75318e947669d95dfd4fc28`
...
- **Trạng thái:** `partial`
- **Vì sao chưa hoàn tất:** Có một phần hành vi và test liên quan trong 2.25.0, nhưng acceptance criteria frontier đầy đủ chưa được đóng nên chưa được tính hoàn thành.
...
- **Vì sao chưa hoàn tất:** Có một phần hành vi và test liên quan trong 2.25.0, nhưng acceptance criteria frontier đầy đủ chưa được đóng nên chưa được tính hoàn thành.
- **Điều kiện hoàn tất:** Hoàn thiện hành vi item-level còn thiếu, thêm kiểm thử tự động trực tiếp và đưa bằng chứng source + test vào feature audit.
- **Bằng chứng hiện có:** src/repository/repository-digital-twin-service.mjs, src/repository/repository-intelligence-fabric.mjs, tests/repository-digital-twin-service.test.mjs, tests/repository-intelligence-fabric-app-wiring.test.mjs, docs/repository-intelligence-fabric-measurement-2.25.0.json
