# Forge Studio 1.7.0 — Remaining Gaps Report

- Tổng yêu cầu: **790**
- Còn lại: **235**
- Hoàn thành một phần: **164**
- Cổng bên ngoài: **52**
- Chưa triển khai: **19**
- Audit SHA-256: `70a41d7289e2a1fd00226402d87844ef5b1abb04a727dfd7c834e2f5af3c966c`
- Receipt SHA-256: `f125e437b7f504a0fc88cdb5d65a8995ce13061d208942252846c4a867025122`
...
- **Vì sao chưa hoàn tất:** Không tìm thấy bằng chứng source + test đủ cụ thể cho mục này trong cây source 1.7.0.
...
- **Trạng thái:** `not_implemented`
- **Vì sao chưa hoàn tất:** Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 1.7.0.
- **Điều kiện hoàn tất:** Xây implementation trong source, nối vào runtime/API hoặc UI thật, thêm kiểm thử trực tiếp và chạy lại full release matrix.
- **Bằng chứng hiện có:** Chưa có
...
## 12. File hướng dẫn agent

### 12.4 — Hỗ trợ hướng dẫn toàn cục

- **Trạng thái:** `partial`
- **Vì sao chưa hoàn tất:** Có thành phần liên quan, nhưng hành vi item-level chưa đầy đủ hoặc chưa được chứng minh trên toàn bộ bề mặt/hạ tầng.
- **Điều kiện hoàn tất:** Hoàn thiện hành vi item-level còn thiếu, thêm kiểm thử tự động trực tiếp và đưa bằng chứng source + test vào feature audit.
- **Bằng chứng hiện có:** src/repository/instruction-discovery.mjs, tests/instruction-discovery.test.mjs

### 12.6 — Hỗ trợ hướng dẫn theo thư mục
...
### 12.7 — Hỗ trợ hướng dẫn theo ngôn ngữ
...
### 12.8 — Hỗ trợ hướng dẫn theo tác vụ
...
### 12.10 — Hỗ trợ ưu tiên hướng dẫn
...
### 12.11 — Phát hiện hướng dẫn mâu thuẫn
...
### 12.18 — Báo hướng dẫn không hợp lệ
...
### 12.19 — Có schema kiểm tra hướng dẫn
...
### 12.20 — Cho phép import tài liệu khác
...
### 13.10 — Lập chỉ mục database model
...
### 13.29 — Hỗ trợ incremental indexing
...
### 13.36 — Xếp hạng theo dependency distance
...
### 13.37 — Xếp hạng theo Git recency
...
### 13.38 — Xếp hạng theo test liên quan
