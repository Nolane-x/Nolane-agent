# Forge Studio 3.0.0 — Limitations and non-claims
...
- `docs/REMAINING-GAPS-3.0.0.md`

## Frontier Governance 3.0 non-claims

- Forge Studio 3.0.0 does not autonomously merge or publish cross-repository changes.
- Forge Studio 3.0.0 does not execute production policy promotion; constitutional authorization still requires human-controlled execution.
- Forge Studio 3.0.0 does not certify real 7–30 day field survival from the deterministic release fixture.
- Forge Studio 3.0.0 does not expand autonomy or capability through self-improvement candidates.
- Forge Studio 3.0.0 does not claim frontier superiority over Codex, Claude Code, Cursor, Copilot, or any other system.
