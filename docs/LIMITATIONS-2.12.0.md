# Forge Studio 2.12.0 — remaining limits
...
The item-level source of truth is `docs/feature-audit-2.12.0.json`. The exhaustive open-item report is `docs/REMAINING-GAPS-2.12.0.md`.
