# Forge Studio 2.0.0 — Remaining Gaps Report

- Tổng yêu cầu: **790**
- Còn lại: **193**
- Hoàn thành một phần: **122**
- Cổng bên ngoài: **52**
- Chưa triển khai: **19**
- Audit SHA-256: `6408b08f3f0ad37daccfb9329b83a229dc76384e8c019d0aa68ab92a75f5063c`
- Receipt SHA-256: `945c7fe8f0ef3af8d1c6ffcfe5ff57c4c58d2b96604b38e41a2e3c81fe533510`
...
- **Vì sao chưa hoàn tất:** Không tìm thấy bằng chứng source + test đủ cụ thể cho mục này trong cây source 2.0.0.
...
- **Trạng thái:** `not_implemented`
- **Vì sao chưa hoàn tất:** Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 2.0.0.
- **Điều kiện hoàn tất:** Xây implementation trong source, nối vào runtime/API hoặc UI thật, thêm kiểm thử trực tiếp và chạy lại full release matrix.
- **Bằng chứng hiện có:** Chưa có
