# Forge Studio 2.2.0 — Kiểm toán checklist tính năng
...
- **4.21 — Trình duyệt tích hợp:** not_implemented — Không tìm thấy bằng chứng source + test đủ cụ thể cho mục này trong cây source 2.2.0.
...
- **4.23 — Trình xem dependency graph:** not_implemented — Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 2.2.0.
...
- **4.30 — Trình quản lý secrets:** not_implemented — Không tìm thấy bằng chứng source + test đủ cụ thể cho mục này trong cây source 2.2.0.
- **4.31 — Trình quản lý sandbox:** not_implemented — Không tìm thấy bằng chứng source + test đủ cụ thể cho mục này trong cây source 2.2.0.
...
- **13.15 — Lập chỉ mục inheritance graph:** not_implemented — Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 2.2.0.
- **13.19 — Lập chỉ mục issue liên quan:** not_implemented — Không tìm thấy bằng chứng source + test đủ cụ thể cho mục này trong cây source 2.2.0.
- **13.21 — Hỗ trợ semantic search:** not_implemented — Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 2.2.0.
- **13.26 — Hỗ trợ AST query:** not_implemented — Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 2.2.0.
- **13.27 — Hỗ trợ tree-sitter:** not_implemented — Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 2.2.0.
...
- **16.3 — Patch theo AST:** not_implemented — Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 2.2.0.
...
- **18.12 — Hỗ trợ giới hạn CPU:** not_implemented — Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 2.2.0.
- **18.13 — Hỗ trợ giới hạn RAM:** not_implemented — Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 2.2.0.
- **18.14 — Hỗ trợ giới hạn process:** not_implemented — Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 2.2.0.
- **18.15 — Hỗ trợ giới hạn disk:** not_implemented — Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 2.2.0.
