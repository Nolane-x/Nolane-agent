# Forge Studio 3.5.0 — Limitations and non-claims
...
- Carry-forward applies only because the content-addressed legacy external runtime manifest, upstream metadata, license, runtime services, application wiring, and server wiring match the protected hashes certified from Forge Studio 3.0.0.
