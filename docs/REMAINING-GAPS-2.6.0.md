# Forge Studio 2.6.0 — Remaining Gaps Report
...
- Cổng bên ngoài: **52**
- Chưa triển khai: **8**
- Audit SHA-256: `239279852f09b8515913547220c40efae8d2fee3acbbd8e6819a6f63ef97ad90`
- Receipt SHA-256: `0232fbbd800c08d503e9ed8c46fb48253c531302e8cd0dedf43bcc75f20b926e`
...
- **Vì sao chưa hoàn tất:** Không tìm thấy bằng chứng source + test đủ cụ thể cho mục này trong cây source 2.6.0.
...
- **Trạng thái:** `not_implemented`
- **Vì sao chưa hoàn tất:** Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 2.6.0.
- **Điều kiện hoàn tất:** Xây implementation trong source, nối vào runtime/API hoặc UI thật, thêm kiểm thử trực tiếp và chạy lại full release matrix.
- **Bằng chứng hiện có:** Chưa có
