# Forge Studio 3.1.0 — Limitations and non-claims
...
- `docs/REMAINING-GAPS-3.1.0.md`

## Frontier Governance 3.0 non-claims

- Forge Studio 3.1.0 does not autonomously merge or publish cross-repository changes.
- Forge Studio 3.1.0 does not execute production policy promotion; constitutional authorization still requires human-controlled execution.
- Forge Studio 3.1.0 does not certify real 7–30 day field survival from the deterministic release fixture.
- Forge Studio 3.1.0 does not expand autonomy or capability through self-improvement candidates.
- Forge Studio 3.1.0 does not claim frontier superiority over Codex, Claude Code, Cursor, Copilot, or any other system.
...
- The 3.1.0 carry-forward gate does not claim that `nolane_native-agent-main.zip` was opened, decompressed, or re-executed in the current run. Its report explicitly records `archiveReadInCurrentRun: false`.
...
- Forge Studio 3.1.0 reuses `ForgeStudio-LegacyExternalRuntime-2.16.0.zip`; it does not publish a new NolaneNative pack or claim that the older artifact is bundled in the 3.1.0 core archives.
