# Forge Studio 2.24.0 — limitations

## Long-Horizon Construction Engine boundary

Forge Studio 2.24.0 compiles structured requirement objects and verifies their internal consistency. It does not claim universal natural-language understanding or that every user intention has been decomposed perfectly.
...
The synthetic measurement in `docs/long-horizon-construction-measurement-2.24.0.json` is deterministic Core contract evidence. Forge Studio 2.24.0 does not claim benchmark superiority over Cursor, Codex, Claude Code, Copilot, Devin or another agent.

The item-level source of truth is `docs/feature-audit-2.24.0.json`. The exhaustive incomplete and externally gated list is `docs/REMAINING-GAPS-2.24.0.md`.
