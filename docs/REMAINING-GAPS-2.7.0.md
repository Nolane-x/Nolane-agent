# Forge Studio 2.7.0 — Remaining Gaps Report
...
- Cổng bên ngoài: **52**
- Chưa triển khai: **6**
- Audit SHA-256: `25bb88f404ff53fe076e43d90451adb6b68c647ced26caf43d0c81ff2864d365`
- Receipt SHA-256: `c7b3f4fa0ff4d0f7dc0b4066274c726f36e183bf2cba179a22e87983ef250ff4`
...
- **Vì sao chưa hoàn tất:** Không tìm thấy bằng chứng source + test đủ cụ thể cho mục này trong cây source 2.7.0.
...
- **Trạng thái:** `not_implemented`
- **Vì sao chưa hoàn tất:** Không tìm thấy implementation và kiểm thử trực tiếp cho mục này trong cây source 2.7.0.
- **Điều kiện hoàn tất:** Xây implementation trong source, nối vào runtime/API hoặc UI thật, thêm kiểm thử trực tiếp và chạy lại full release matrix.
- **Bằng chứng hiện có:** Chưa có
