...
function copy(language) {
  ...
  return vi ? {
    ...
    useInMission: 'Dùng trong nhiệm vụ tiếp theo', useInMissionDetail: 'Skill sẽ được chọn rõ ràng và kiểm tra lại trước khi agent đọc.', manage: 'Quản trị extension', manageDetail: 'Cài đặt và quyền hạn vẫn nằm trong Control Plane.',
  } : {
    ...
    useInMission: 'Use in next mission', useInMissionDetail: 'The skill is explicitly selected and checked again before the agent reads it.', manage: 'Manage extensions', manageDetail: 'Installation and permissions remain in the Control Plane.',
  };
}
