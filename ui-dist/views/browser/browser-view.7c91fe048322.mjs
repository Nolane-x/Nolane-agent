import { renderBrowserInspector } from './browser-inspector.3f378aaedef0.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.e8d3e96356e8.mjs';
