import { renderBrowserInspector } from './browser-inspector.f6144da539c6.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.2fd7c4bd09d3.mjs';
