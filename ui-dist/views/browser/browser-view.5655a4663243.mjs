import { renderBrowserInspector } from './browser-inspector.593877d5d79f.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.9e8fb4d7bf83.mjs';
