import { renderBrowserInspector } from './browser-inspector.aa9b7733febf.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.ab55e83339a3.mjs';
