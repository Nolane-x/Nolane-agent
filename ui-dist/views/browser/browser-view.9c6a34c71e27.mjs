import { renderBrowserInspector } from './browser-inspector.315c20f6ea56.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.6acef058a98d.mjs';
