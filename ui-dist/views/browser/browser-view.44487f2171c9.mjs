import { renderBrowserInspector } from './browser-inspector.1b184b5d8e7a.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.91e2396ced3d.mjs';
