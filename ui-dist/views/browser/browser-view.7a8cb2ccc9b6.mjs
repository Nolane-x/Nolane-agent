import { renderBrowserInspector } from './browser-inspector.b0aea31cffc0.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.e354b7a25f60.mjs';
