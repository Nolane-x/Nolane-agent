import { renderBrowserInspector } from './browser-inspector.74542e5d9df6.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.99718569f567.mjs';
