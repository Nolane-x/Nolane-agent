import { renderBrowserInspector } from './browser-inspector.1eb74ddedc22.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.f8dc2d4fa297.mjs';
