import { renderBrowserInspector } from './browser-inspector.67ca70841fcf.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.963699f66d7f.mjs';
