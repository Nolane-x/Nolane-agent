import { renderBrowserInspector } from './browser-inspector.3a2972779cd8.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.5d785e836cfe.mjs';
