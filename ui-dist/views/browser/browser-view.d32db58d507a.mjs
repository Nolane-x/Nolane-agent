import { renderBrowserInspector } from './browser-inspector.2ebda413ff5f.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.ec8d75f572b6.mjs';
