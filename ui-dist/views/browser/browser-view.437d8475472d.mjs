import { renderBrowserInspector } from './browser-inspector.e30b05436a2f.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.6b197c8d6e76.mjs';
