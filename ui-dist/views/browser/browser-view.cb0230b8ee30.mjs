import { renderBrowserInspector } from './browser-inspector.43ddf8da38aa.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.12f976f855eb.mjs';
