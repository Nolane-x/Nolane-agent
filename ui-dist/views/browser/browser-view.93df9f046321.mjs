import { renderBrowserInspector } from './browser-inspector.76379a7ff600.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.9f719109e0cf.mjs';
