import { renderBrowserInspector } from './browser-inspector.9ebabe3b6dbc.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.1d6e8e0a9ff1.mjs';
