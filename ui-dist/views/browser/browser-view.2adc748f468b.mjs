import { renderBrowserInspector } from './browser-inspector.05f9f7dd1e25.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.4c6631c0dfb8.mjs';
