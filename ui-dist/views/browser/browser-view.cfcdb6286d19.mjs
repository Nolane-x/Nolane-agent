import { renderBrowserInspector } from './browser-inspector.4d42cee818c9.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.3011f39b7d69.mjs';
