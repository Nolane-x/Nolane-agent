import { renderBrowserInspector } from './browser-inspector.aa8410adfa90.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.56d5e95fb337.mjs';
