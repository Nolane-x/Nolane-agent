import { renderBrowserInspector } from './browser-inspector.3c3823cd40a3.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.05a63ea17eb3.mjs';
