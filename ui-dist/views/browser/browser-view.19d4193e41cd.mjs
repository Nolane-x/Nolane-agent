import { renderBrowserInspector } from './browser-inspector.9e390ddc0ca9.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.991e7d17f03d.mjs';
