import { renderBrowserInspector } from './browser-inspector.fac2e2da2ea0.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.c6e09cf1baf3.mjs';
