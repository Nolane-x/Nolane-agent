import { renderBrowserInspector } from './browser-inspector.fcb9a9946eb8.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.095a7c9382fa.mjs';
