import { renderBrowserInspector } from './browser-inspector.07d69134b17a.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.77fa8385fecf.mjs';
