import { renderBrowserInspector } from './browser-inspector.5be40ec925ce.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.814f7cb99fda.mjs';
