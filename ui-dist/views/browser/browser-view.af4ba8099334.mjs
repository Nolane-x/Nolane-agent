import { renderBrowserInspector } from './browser-inspector.3b81f74f3a6d.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.b831d62f8f92.mjs';
