import { renderBrowserInspector } from './browser-inspector.a8b208b5cba5.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.439d46528e0a.mjs';
