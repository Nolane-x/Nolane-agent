import { renderBrowserInspector } from './browser-inspector.be7477f4bcf9.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.f8a90c0ac572.mjs';
