import { renderBrowserInspector } from './browser-inspector.786fb68aea7a.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.6cae52d4f326.mjs';
