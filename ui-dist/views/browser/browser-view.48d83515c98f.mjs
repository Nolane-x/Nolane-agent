import { renderBrowserInspector } from './browser-inspector.b80f024ee78f.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.5cdd31638710.mjs';
