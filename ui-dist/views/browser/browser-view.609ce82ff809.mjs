import { renderBrowserInspector } from './browser-inspector.18da963bede3.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.3bffc9d42ae3.mjs';
