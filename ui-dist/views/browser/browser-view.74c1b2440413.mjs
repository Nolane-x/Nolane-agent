import { renderBrowserInspector } from './browser-inspector.0d2c9b766c0e.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.9ed11ce52cc1.mjs';
