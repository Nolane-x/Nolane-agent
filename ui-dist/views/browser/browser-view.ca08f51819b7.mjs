import { renderBrowserInspector } from './browser-inspector.a25dba2bcf36.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.59dd9b57aa12.mjs';
