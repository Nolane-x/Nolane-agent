import { renderBrowserInspector } from './browser-inspector.2b3efe609ecc.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.1fa6ffeeb7b7.mjs';
