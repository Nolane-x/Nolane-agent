import { renderBrowserInspector } from './browser-inspector.da7c3f35bcb0.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.8a9a3b8762a6.mjs';
