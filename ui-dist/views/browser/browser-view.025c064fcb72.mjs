import { renderBrowserInspector } from './browser-inspector.49c46322d1d7.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.84938e1584fd.mjs';
