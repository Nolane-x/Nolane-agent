import { renderBrowserInspector } from './browser-inspector.30ac37db56f7.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.c811fb0dfcdb.mjs';
