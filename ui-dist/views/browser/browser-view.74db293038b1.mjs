import { renderBrowserInspector } from './browser-inspector.a4e72894e4db.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.fcca50ea52cf.mjs';
