import { renderBrowserInspector } from './browser-inspector.8434c3026ac1.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.3695315264a4.mjs';
