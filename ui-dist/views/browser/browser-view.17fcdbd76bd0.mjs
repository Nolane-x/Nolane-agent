import { renderBrowserInspector } from './browser-inspector.09bbcb896ee6.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.dfcce02ffb10.mjs';
