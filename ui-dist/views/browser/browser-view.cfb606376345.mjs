import { renderBrowserInspector } from './browser-inspector.2c6e95dcfed8.mjs';
import { defaultBrowserTimeline, renderBrowserTimeline } from './browser-timeline.2bc42b87583d.mjs';
