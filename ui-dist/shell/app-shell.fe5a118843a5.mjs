import { GLOBAL_DESTINATIONS, renderGlobalRail } from './global-rail.eaee55992464.mjs';
import { createSessionSidebarModel, renderSessionSidebar } from './session-sidebar.8ac00e9af7da.mjs';
import { icon } from '../core/icon.29cff64feb0e.mjs';
import { experienceMeta, normalizeExperience } from '../core/experience-policy.590cd60f7932.mjs';
import { t } from '../core/i18n.576ca00f8535.mjs';
import { renderExperienceSwitcher } from '../components/experience-switcher/experience-switcher.aec9d679238f.mjs';
