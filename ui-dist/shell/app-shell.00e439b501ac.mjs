import { GLOBAL_DESTINATIONS, renderGlobalRail } from './global-rail.92a38b1c3d86.mjs';
import { createSessionSidebarModel, renderSessionSidebar } from './session-sidebar.06a3f93e94f4.mjs';
import { icon } from '../core/icon.2f5a1e893bde.mjs';
import { experienceMeta, normalizeExperience } from '../core/experience-policy.db9f4bef713a.mjs';
import { t } from '../core/i18n.7dae06ae5e1f.mjs';
import { renderExperienceSwitcher } from '../components/experience-switcher/experience-switcher.25ec532ddad8.mjs';
