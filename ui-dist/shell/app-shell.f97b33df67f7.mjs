import { GLOBAL_DESTINATIONS, renderGlobalRail } from './global-rail.f4e0b90358c1.mjs';
import { createSessionSidebarModel, renderSessionSidebar } from './session-sidebar.14fff2ba94e0.mjs';
import { icon } from '../core/icon.584adb4905a7.mjs';
import { experienceMeta, normalizeExperience } from '../core/experience-policy.6008dc729d7b.mjs';
import { t } from '../core/i18n.31614bcf03b6.mjs';
import { renderExperienceSwitcher } from '../components/experience-switcher/experience-switcher.33571d9fff1b.mjs';
