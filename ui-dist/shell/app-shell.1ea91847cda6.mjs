import { GLOBAL_DESTINATIONS, renderGlobalRail } from './global-rail.506712961192.mjs';
import { createSessionSidebarModel, renderSessionSidebar } from './session-sidebar.9aa181b1af94.mjs';
import { icon } from '../core/icon.f84207003a6a.mjs';
import { experienceMeta, normalizeExperience } from '../core/experience-policy.29bd49a81ae1.mjs';
import { t } from '../core/i18n.863caa0e5cc7.mjs';
import { renderExperienceSwitcher } from '../components/experience-switcher/experience-switcher.8e30a996fd1d.mjs';
