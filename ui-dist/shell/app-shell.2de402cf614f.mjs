import { GLOBAL_DESTINATIONS, renderGlobalRail } from './global-rail.0c25f19c0fa4.mjs';
import { createSessionSidebarModel, renderSessionSidebar } from './session-sidebar.024276a256b3.mjs';
import { icon } from '../core/icon.d2e8bd0e31d1.mjs';
import { experienceMeta, normalizeExperience } from '../core/experience-policy.9e518a5ee296.mjs';
import { t } from '../core/i18n.6dedfb116519.mjs';
import { renderExperienceSwitcher } from '../components/experience-switcher/experience-switcher.74aa7f0613d5.mjs';
