import { GLOBAL_DESTINATIONS, renderGlobalRail } from './global-rail.46233845605c.mjs';
import { createSessionSidebarModel, renderSessionSidebar } from './session-sidebar.837d8dd875c2.mjs';
import { icon } from '../core/icon.060e3029c478.mjs';
import { experienceMeta, normalizeExperience } from '../core/experience-policy.5834cff3b888.mjs';
import { t } from '../core/i18n.eeee152f90c2.mjs';
import { renderExperienceSwitcher } from '../components/experience-switcher/experience-switcher.62f72854badf.mjs';
