import { GLOBAL_DESTINATIONS, renderGlobalRail } from './global-rail.25f6c53df4a4.mjs';
import { createSessionSidebarModel, renderSessionSidebar } from './session-sidebar.6c6792a57010.mjs';
import { icon } from '../core/icon.2c3aae9482de.mjs';
import { experienceMeta, normalizeExperience } from '../core/experience-policy.8ba55c6e8cbc.mjs';
import { t } from '../core/i18n.a349d89a5e5f.mjs';
import { renderExperienceSwitcher } from '../components/experience-switcher/experience-switcher.b70a0cc453cf.mjs';
