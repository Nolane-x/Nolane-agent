import { GLOBAL_DESTINATIONS, renderGlobalRail } from './global-rail.7a1a6e910ad0.mjs';
import { createSessionSidebarModel, renderSessionSidebar } from './session-sidebar.072006aaf1b2.mjs';
import { icon } from '../core/icon.dbcc31ee15f3.mjs';
import { renderNolaneMark } from '../core/brand.0020e4572b5d.mjs';
import { experienceMeta, normalizeExperience } from '../core/experience-policy.f08ff60361b3.mjs';
import { t } from '../core/i18n.363a01ee1419.mjs';
import { renderExperienceSwitcher } from '../components/experience-switcher/experience-switcher.3c58a98fe219.mjs';
