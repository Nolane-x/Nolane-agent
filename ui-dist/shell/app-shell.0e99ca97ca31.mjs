import { GLOBAL_DESTINATIONS, renderGlobalRail } from './global-rail.63ade7b892a5.mjs';
import { createSessionSidebarModel, renderSessionSidebar } from './session-sidebar.ec72ce13fc49.mjs';
import { icon } from '../core/icon.32de196de6c4.mjs';
import { experienceMeta, normalizeExperience } from '../core/experience-policy.c555a9d66195.mjs';
import { t } from '../core/i18n.e1eea3e8c3a6.mjs';
import { renderExperienceSwitcher } from '../components/experience-switcher/experience-switcher.674a89e7c637.mjs';
