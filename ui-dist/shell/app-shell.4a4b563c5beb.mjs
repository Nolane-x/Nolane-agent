import { GLOBAL_DESTINATIONS, renderGlobalRail } from './global-rail.744255d8c11f.mjs';
import { createSessionSidebarModel, renderSessionSidebar } from './session-sidebar.dbf5856320a4.mjs';
import { icon } from '../core/icon.b5a96d33ac64.mjs';
import { experienceMeta, normalizeExperience } from '../core/experience-policy.f1f147a3534f.mjs';
import { t } from '../core/i18n.73ff364941c3.mjs';
import { renderExperienceSwitcher } from '../components/experience-switcher/experience-switcher.4fcf56c157f8.mjs';
