import { GLOBAL_DESTINATIONS, renderGlobalRail } from './global-rail.f3508a6f4236.mjs';
import { createSessionSidebarModel, renderSessionSidebar } from './session-sidebar.5d574daeb2bd.mjs';
import { icon } from '../core/icon.017c4e4259b2.mjs';
import { experienceMeta, normalizeExperience } from '../core/experience-policy.86e6cdb15cb9.mjs';
import { t } from '../core/i18n.910dcb674fa3.mjs';
import { renderExperienceSwitcher } from '../components/experience-switcher/experience-switcher.714fc235aca7.mjs';
