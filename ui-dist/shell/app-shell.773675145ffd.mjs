import { GLOBAL_DESTINATIONS, renderGlobalRail } from './global-rail.ceac810d77cd.mjs';
import { createSessionSidebarModel, renderSessionSidebar } from './session-sidebar.00e9b880e0a1.mjs';
import { icon } from '../core/icon.e9da458be38f.mjs';
import { experienceMeta, normalizeExperience } from '../core/experience-policy.9d0c5cdd3ff6.mjs';
import { t } from '../core/i18n.01c45a8fd27c.mjs';
import { renderExperienceSwitcher } from '../components/experience-switcher/experience-switcher.80069c96ccc0.mjs';
