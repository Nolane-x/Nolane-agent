import { GLOBAL_DESTINATIONS, renderGlobalRail } from './global-rail.c3f0c7594f63.mjs';
import { createSessionSidebarModel, renderSessionSidebar } from './session-sidebar.0fb6f0bde598.mjs';
import { icon } from '../core/icon.a8b6e293bcae.mjs';
import { experienceMeta, normalizeExperience } from '../core/experience-policy.621cf349fb0b.mjs';
import { t } from '../core/i18n.cce18c9d8ca5.mjs';
import { renderExperienceSwitcher } from '../components/experience-switcher/experience-switcher.e43d322c968e.mjs';
