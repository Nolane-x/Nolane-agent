import { GLOBAL_DESTINATIONS, renderGlobalRail } from './global-rail.3fbad526e57a.mjs';
import { createSessionSidebarModel, renderSessionSidebar } from './session-sidebar.fd541170cebe.mjs';
import { icon } from '../core/icon.b299c9832158.mjs';
import { experienceMeta, normalizeExperience } from '../core/experience-policy.edffc1797d1d.mjs';
import { t } from '../core/i18n.992e75b62dfb.mjs';
import { renderExperienceSwitcher } from '../components/experience-switcher/experience-switcher.5c6f8c6b32d1.mjs';
