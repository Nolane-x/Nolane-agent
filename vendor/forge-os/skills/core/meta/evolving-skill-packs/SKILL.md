---
name: evolving-skill-packs
description: "Use when evolving skill packs is required during meta work, especially when the result must be traceable, independently reviewable, and safe to hand to another agent."
license: MIT
...
# Evolving Skill Packs

## Overview

This skill owns one bounded responsibility: **evolving skill packs**. Its focus is evolving skill packs within meta lifecycle boundaries. It converts declared inputs into typed artifacts and reproducible evidence without silently changing product scope.
...
1. Define the exact decision, actors, objects, states, invariants, side effects, and non-goals owned by evolving skill packs.
2. Build a decision table for normal, boundary, invalid, permission, failure, retry, recovery, concurrency, migration, and abuse conditions relevant to evolving skill packs.
3. Apply evolving skill packs only to direct input artifacts; record assumptions, rejected alternatives, and any human decision still required.
4. Trace the resulting contract to user value, security, reliability, cost, operability, and downstream consumers.
5. Create reproducible checks that would fail if evolving skill packs were incomplete or implemented incorrectly.
...
3. Define the exact decision, actors, objects, states, invariants, side effects, and non-goals owned by evolving skill packs.
4. Build a decision table for normal, boundary, invalid, permission, failure, retry, recovery, concurrency, migration, and abuse conditions relevant to evolving skill packs.
5. Apply evolving skill packs only to direct input artifacts; record assumptions, rejected alternatives, and any human decision still required.
6. Trace the resulting contract to user value, security, reliability, cost, operability, and downstream consumers.
7. Create reproducible checks that would fail if evolving skill packs were incomplete or implemented incorrectly.
...
- Does the artifact make the owned decision for evolving skill packs explicit and bounded?
...
- `evolving-skill-packs-decision-table`
- `evolving-skill-packs-verification-report`
- `evolving-skill-packs-handoff-envelope`
...
- The output directly and completely performs evolving skill packs within its declared boundary.
- Does the artifact make the owned decision for evolving skill packs explicit and bounded?
- Are failure, recovery, permissions, concurrency, and irreversible side effects addressed where applicable?
- Can every load-bearing claim be traced to a confirmed fact, direct artifact, executable check, or declared assumption?
- Would a downstream agent know exactly what changed, what remains open, and what must be invalidated?
...
- treating evolving skill packs as a naming exercise
...
- Required evidence: `contract-validation`, `independent-review`, `evolving-skill-packs-decision-table`, `evolving-skill-packs-verification-report`, `evolving-skill-packs-handoff-envelope`.
