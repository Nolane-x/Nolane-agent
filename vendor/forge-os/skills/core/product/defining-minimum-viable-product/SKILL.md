---
name: defining-minimum-viable-product
description: "Use when defining minimum viable product is required during product work, especially when the result must be traceable, independently reviewable, and safe to hand to another agent."
license: MIT
...
This skill owns one bounded responsibility: **defining minimum viable product**. Its focus is identify the smallest end-to-end product that tests the product thesis rather than a pile of disconnected features. It converts declared inputs into typed artifacts and reproducible evidence without silently changing product scope.
...
1. State the product thesis and riskiest causal assumption.
2. Map the single critical user journey that can falsify the thesis.
3. Include only capabilities required to complete and measure that journey.
4. Define operational, security, accessibility, and recovery minimums that cannot be deferred.
5. Move every other capability to a later hypothesis with an explicit trigger for reconsideration.

## Procedure

1. Read confirmed evidence, selected concept, and unresolved assumptions.
2. Define the product decision this skill owns.
3. State the product thesis and riskiest causal assumption.
4. Map the single critical user journey that can falsify the thesis.
5. Include only capabilities required to complete and measure that journey.
6. Define operational, security, accessibility, and recovery minimums that cannot be deferred.
7. Move every other capability to a later hypothesis with an explicit trigger for reconsideration.
...
- Does the MVP deliver user value end to end?
- Can it test the riskiest assumption?
- Are reliability and security basics treated as scope, not polish?
- Can every included feature name the thesis dependency it serves?
...
- The output directly and completely performs defining minimum viable product within its declared boundary.
- Does the MVP deliver user value end to end?
- Can it test the riskiest assumption?
- Are reliability and security basics treated as scope, not polish?
- Can every included feature name the thesis dependency it serves?
...
- building infrastructure without a user loop
...
- Required evidence: `contract-validation`, `independent-review`, `MVP capability map`, `critical journey`, `non-goal list`, `experiment plan`.
