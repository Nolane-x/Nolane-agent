...
- Skills: `designing-mobile-offline-mode`, `designing-mobile-permissions`, `testing-mobile-devices`, `optimizing-mobile-battery`, `designing-mobile-sync`, `testing-mobile-deep-links`, `preparing-mobile-store-release`, `monitoring-mobile-crashes`
