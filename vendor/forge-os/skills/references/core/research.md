# Research Core Pack Playbook

This reference is loaded on demand by ForgeOS skills. It does not replace the selected skill's contract.

## Pack boundary

- Lifecycle coverage: discovery → research
- Skills: `scoping-product-research`, `mapping-existing-solutions`, `analyzing-competing-products`, `extracting-user-pain`, `mining-user-workarounds`, `mapping-jobs-to-be-done`, `identifying-market-shifts`, `validating-source-credibility`, `synthesizing-product-evidence`, `maintaining-prior-art-map`
