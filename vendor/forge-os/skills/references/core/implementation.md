# Implementation Core Pack Playbook
...
- Skills: `developing-features-with-tdd`, `fixing-bugs-with-tdd`, `implementing-contract-first`, `writing-minimal-sufficient-code`, `refactoring-with-behavior-preservation`, `enforcing-domain-language`, `controlling-code-complexity`, `preventing-duplicate-abstractions`, `reviewing-code-diffs`, `reviewing-critical-code-line-by-line`, `managing-software-dependencies`, `documenting-public-interfaces`
