...
- Skills: `writing-executable-plans`, `slicing-vertical-increments`, `mapping-acceptance-contracts`, `classifying-delivery-risk`, `sequencing-task-dependencies`, `assigning-agent-work`, `isolating-development-work`, `tracking-evidence-backed-progress`, `managing-change-impact`, `deciding-release-scope`
