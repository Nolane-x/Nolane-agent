...
const outputFile = path.join(root, 'release', `command-execution-governance-${identity.version}.json`);
const report = await verifyCommandExecutionGovernance({ rootDirectory: root, version: identity.version, outputFile });
