...
const outputFile=path.join(root,'release',`mission-completion-runtime-readiness-${identity.version}.json`);
const report=await verifyMissionCompletionRuntimeReadiness({rootDirectory:root,version:identity.version,outputFile});
