...
const outputFile = path.join(root, 'release', `local-worktree-handoff-${identity.version}.json`);
const report = await verifyLocalWorktreeHandoff({ rootDirectory: root, version: identity.version, outputFile });
