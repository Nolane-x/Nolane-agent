...
const output = path.join(root, 'release', `intelligence-completion-kernel-${metadata.version}.json`);
const report = await verifyIntelligenceCompletionKernel({ rootDirectory: root, version: metadata.version, outputFile: output });
