...
const outputFile = path.join(root, 'release', `semantic-dependency-${identity.version}.json`);
const report = await verifySemanticDependencyIntelligence({ rootDirectory: root, version: identity.version, outputFile });
