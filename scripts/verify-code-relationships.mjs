...
const outputFile = path.join(root, 'release', `code-relationship-intelligence-${identity.version}.json`);
const report = await verifyCodeRelationshipIntelligence({ rootDirectory: root, version: identity.version, outputFile });
