...
const output = path.join(root, 'release', `verified-mission-runtime-${metadata.version}.json`);
const report = await verifyVerifiedMissionRuntime({ rootDirectory: root, version: metadata.version, outputFile: output });
