...
const outputFile = path.join(root, 'release', `adaptive-microkernel-${identity.version}.json`);
const report = await verifyAdaptiveMicrokernel({ rootDirectory: root, version: identity.version, outputFile });
