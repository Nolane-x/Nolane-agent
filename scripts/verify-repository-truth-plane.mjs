...
const output = path.join(root, 'release', `repository-truth-plane-${metadata.version}.json`);
const report = await verifyRepositoryTruthPlane({ rootDirectory: root, version: metadata.version, outputFile: output });
