...
const output = path.join(root, 'release', `construction-safety-completion-${metadata.version}.json`);
const report = await verifyConstructionSafetyCompletion({ rootDirectory: root, version: metadata.version, outputFile: output });
