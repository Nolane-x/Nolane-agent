...
const outputFile = path.join(root, 'release', `git-completion-governance-${identity.version}.json`);
const report = await verifyGitCompletionGovernance({ rootDirectory: root, version: identity.version, outputFile });
