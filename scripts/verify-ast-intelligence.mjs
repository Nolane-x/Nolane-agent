...
const outputFile = path.join(root, 'release', `ast-intelligence-${identity.version}.json`);
const report = await verifyAstIntelligence({ rootDirectory: root, version: identity.version, outputFile });
