...
<div align="center">
  ...
  <a href="https://github.com/Nolane-x/Nolane-agent/releases/tag/v0.0.2"><img src="https://img.shields.io/github/v/release/Nolane-x/Nolane-agent?display_name=tag&sort=semver" alt="Release" /></a>
  ...
  <a href="https://github.com/Nolane-x/Nolane-agent/releases/tag/v0.0.2"><img src="https://img.shields.io/badge/platforms-Windows%20%7C%20macOS%20%7C%20Linux-7c6cf0" alt="Windows, macOS, and Linux" /></a>
</div>
...
`v0.0.2` is the current release candidate. Historical checkpoint and beta documents remain in the repository as immutable provenance; they are not the current release documentation.

| Download | Package |
| --- | --- |
| Windows | [NSIS installer (.exe)](https://github.com/Nolane-x/Nolane-agent/releases/download/v0.0.2/NolaneAgent-Setup-0.0.2-x64.exe) |
| macOS | [DMG](https://github.com/Nolane-x/Nolane-agent/releases/download/v0.0.2/NolaneAgent-0.0.2-x64.dmg) or [ZIP](https://github.com/Nolane-x/Nolane-agent/releases/download/v0.0.2/NolaneAgent-0.0.2-x64.zip) |
| Linux | [AppImage](https://github.com/Nolane-x/Nolane-agent/releases/download/v0.0.2/NolaneAgent-0.0.2-x86_64.AppImage) or [Debian package](https://github.com/Nolane-x/Nolane-agent/releases/download/v0.0.2/NolaneAgent-0.0.2-amd64.deb) |
...
1. Download the [Windows installer](https://github.com/Nolane-x/Nolane-agent/releases/download/v0.0.2/NolaneAgent-Setup-0.0.2-x64.exe), [macOS DMG](https://github.com/Nolane-x/Nolane-agent/releases/download/v0.0.2/NolaneAgent-0.0.2-x64.dmg), or [Linux AppImage](https://github.com/Nolane-x/Nolane-agent/releases/download/v0.0.2/NolaneAgent-0.0.2-x86_64.AppImage).
...
The public [v0.0.2 release](https://github.com/Nolane-x/Nolane-agent/releases/tag/v0.0.2) is built entirely by GitHub Actions and includes checksums plus provenance attestation. The artifacts are currently unsigned: Windows may show **Unknown Publisher**, and macOS Gatekeeper may require an explicit user confirmation. Authenticode and Apple signing are future hardening work, not release gates for Nolane Agent 0.0.2.
...
- [Release notes](docs/RELEASE-0.0.2.md)
- [Known limitations](docs/LIMITATIONS-0.0.2.md)
- [Verification scope](docs/VERIFICATION-REPORT-0.0.2.md)
- [Remaining gaps](docs/REMAINING-GAPS-0.0.2.md)
