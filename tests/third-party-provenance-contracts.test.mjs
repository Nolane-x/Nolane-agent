...
test('third party provenance contract preserves MIT attribution and clean-room transformation accounting', async () => {
...
test('third party provenance contract rejects missing attribution ownership claims and distributed NolaneNative runtime claims', async () => {
  const noticeText = await readFile('THIRD_PARTY_NOTICES.md', 'utf8');
