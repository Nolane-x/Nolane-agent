...
test('external gate workflow aggregates runner receipts only from successful pull-request or release-branch push triggers into a read-only certification candidate artifact', async () => {
