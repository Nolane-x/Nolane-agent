...
test('external gate workflow aggregates runner receipts from successful pull requests, main pushes, or manual dispatches into a read-only certification candidate artifact', async () => {
