...
export function createBuiltInCliProviders(overrides = {}) {
  const definitions = [
    ...
    { id: 'grok-build', label: 'xAI Grok Build', executable: 'agent', harnessFamily: 'grok-build-cli', baseArgs: ['--permission-mode', 'plan', '--output-format', 'json'], promptMode: 'arg', promptFlag: '-p', modelFlag: '--model', modelDiscoveryArgs: ['models'], profile: { capabilities: ['coding', 'structured-output', 'subscription-auth', 'governed-actions'], qualityTier: 4, costTier: 0, latencyTier: 2 } },
